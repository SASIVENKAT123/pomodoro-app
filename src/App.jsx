  ...
  return (
    ...
    {/* //header */}
      ...
      <header className="flex justify-between items-center px-8 py-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-white/25" />
            <span className ="text-[#D4AF37] font-bold font-sans">Welcome, <strong>ZORO</strong></span>
          
        </div>

        <nav className ="flex gap-6 text-white/50 text-sm font-sans">
          <a href="#" className="hover:text-red-900">Plan your day</a>
      ...
      <footer className="text-center py-5 text-white/50 text-lg font-sans">
        ...
        minutes today - keep going <strong className="text-white/80">"ZORO"</strong>
